...
- When performing read operations and code analysis, use the `/serena` command for enhanced functionality
- The `/serena` command reference can be found in `.claude/commands/serena.md`